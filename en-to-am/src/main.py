...
# Simple usage
# text = "ሰላም ልጅ እንዴት ነህ?"
# latin = convert_amharic_to_latin(text)
# print(latin)  # selam lij endet neh?

# # Works with mixed text (English letters preserved)
# text = "ሰላም hello እንዴት world"
# latin = convert_amharic_to_latin(text)
# print(latin)  # selam hello endet world
